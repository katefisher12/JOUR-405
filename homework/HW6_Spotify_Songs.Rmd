...
The distribution is mostly normal but is slightly skewed to the right. The mean and standard deviation prove that most songs have at least some dancibiilty to them. The story I would write based on this data is about the songs that are considered to have near a 100% dancilibility score. In my story I would indicate those songs and ask the simple question of "why?" It would also be cool to go out on the street to do some street interviews and have random people listen to those songs to see if they break out in dance to prove the data theory. 
